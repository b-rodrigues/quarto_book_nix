...
Finally, an action I defined runs, `quarto-nix-actions/publish`. This is
a fork of the `quarto-actions/publish` action which you can find
...
run in the Nix environment defined for the project.
